...
int main(int argc, char const *argv[]) {
  ...
  init_hero(marvin,20,420,420,1,2,1,"marvin","🧙‍",1,pt_m,mage_blanc); // on initit la structure marvin avec ses stats
  //un deuxieme
  personnage_t * Zeddicus_Zul_Zorander = malloc(sizeof(personnage_t));
  init_hero(Zeddicus_Zul_Zorander,25,350,350,3,4,2,"Zeddicus Zul'Zorander","🧞‍",1,pt_m,mage_noir);

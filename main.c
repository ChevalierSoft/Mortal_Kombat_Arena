...
//  personnage_t * marvin = malloc(sizeof(personnage_t)); // creer une structure marvin qui est un mage
  //_mage, _force,  _PV, _px, _py,  _pm,  _nom, *_pp, _nb_att
//  init_hero(marvin,20,420,1,2,1,"marvin","🧙‍",1,pt_m,mage_blanc); // on initit la structure marvin avec ses stats
  //un deuxieme
  personnage_t * Zeddicus_Zul_Zorander = malloc(sizeof(personnage_t));
  init_hero(Zeddicus_Zul_Zorander,25,350,3,4,2,"Zeddicus Zul'Zorander","🧞‍",1,pt_m,mage_noir);

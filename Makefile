START : main.o reseau.o attaques.o init_structure.o menu.o map.o liste_ptr.o load_perso.o
	gcc -o START main.o reseau.o attaques.o init_structure.o menu.o map.o liste_ptr.o load_perso.o -lcrypto
